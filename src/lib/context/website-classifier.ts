...
const CLASSIFICATION_RULES: { type: WebsiteType; keywords: string[] }[] = [
    {
        type: "job_portal",
        keywords: ["jobs", "careers", "hiring", "employment", "recruiting", "workday", "greenhouse.io", "lever.co", "linkedin.com/jobs", "opportunities", "professional", "workday",],
    },
    {
        type: "social",
    ...
    {
        type: "rental",
        keywords: ["rent", "apartment", "lease", "property", "zillow", "apartments.com"],
    },
    {
        type: "survey",
