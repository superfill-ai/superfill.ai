import { allowedCategories } from "@superfill/shared/copies";
import {
  ERROR_MESSAGE_API_KEY_NOT_CONFIGURED,
  ERROR_MESSAGE_PROVIDER_NOT_CONFIGURED,
} from "@superfill/shared/errors";
import { createLogger } from "@superfill/shared/logger";
import type { FieldMetadataSnapshot } from "@superfill/shared/types/autofill";
...
import { Combobox, type ComboboxOption } from "@superfill/ui/combobox";
import {
  Field,
  FieldDescription,
  FieldError,
...
import { InputBadge } from "@superfill/ui/input-badge";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { Textarea } from "@superfill/ui/textarea";
